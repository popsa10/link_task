                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10.h,),
                      Text.rich(TextSpan(
                          text: "بإنشاء حسابك أنت توافق على ",style: const TextStyle(fontSize: 14,fontWeight: FontWeight.w500),
                          children:  [
                            TextSpan(
                              text: "شروط وأحكام",
                              style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold,color: AppColors.greyColor,decoration: TextDecoration.underline,decorationColor: Colors.black),
                            ),
                            TextSpan(
                              text: " حلاق",
                              style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: AppColors.greyColor),
                            ),
